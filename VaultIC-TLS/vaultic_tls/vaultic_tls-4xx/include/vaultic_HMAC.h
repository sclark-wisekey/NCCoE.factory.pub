...
#ifndef VAULTIC___SIGNER_HMAC_
#define VAULTIC___SIGNER_HMAC_
...
typedef struct 
{
	...
	VLT_U8 u8blockSize;
    VLT_U16 u8outputSize;

} VLT_HMAC_PARAMS;

#define HMAC_PARAMS VLT_HMAC_PARAMS // backward compatibility
